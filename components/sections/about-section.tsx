      ...
      <div className="section-container">
        <div className="text-center mb-16">
          ...
          <p className="text-muted-foreground text-center max-w-2xl mx-auto mb-12">
            Akpu Students Union (ASU) is a well-recognized and respected student body
            representing indigenous students of Akpu Town across various academic
        ...
        <div className="grid lg:grid-cols-2 gap-12 mb-16">
          <div className="bg-card rounded-xl p-8 shadow-card border border-border">
            ...
            <p className="text-muted-foreground mb-4 leading-relaxed">
              Akpu Town, also known as Akpujiogu, is one of the indigenous communities
              in the Orumba region of Anambra State. It is bounded by Ufuma, Nawfija,
              and Ogboji, and plays host to three communities: Ajalli, Ndiokpalaeze,
              and Ndiokolo.
            </p>
            <p className="text-muted-foreground leading-relaxed">
              Akpu is a proud Igbo town with a rich cultural heritage. The town
              comprises 15 villages and is governed by the traditional ruler{" "}
              <span className="font-semibold text-foreground">
                Igwe Ezeukwu Akpu
              </span>
              , supported by the Onowu, cabinet members, and other recognized
          ...
          <div className="bg-card rounded-xl p-8 shadow-card border border-border">
            ...
            <p className="text-muted-foreground mb-4 leading-relaxed">
              Akpu Students Union (ASU) is an independent student body operating under
              the Akpu Town Union. The union brings together Akpu students nationwide,
              fostering unity, leadership, academic excellence, and community service.
            </p>
            <p className="text-muted-foreground leading-relaxed">
              ASU has produced many respected leaders who contribute positively to Akpu
              Town and society at large. The union serves as a platform for academic
              development, leadership grooming, cultural preservation, and student
              welfare.
            </p>
          </div>
        </div>
